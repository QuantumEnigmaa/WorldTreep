...
@Component({
  ...
  template: `
    ...
    <div *ngFor="let content of id" [attr.id]='content' style="background-image: url(../assets/Africa-tree.jpg);
    background-repeat: no-repeat; background-size: 100%;">
      <h1 id="tallest" style="text-align: center; color: white;">Les plus grands arbres</h1>
